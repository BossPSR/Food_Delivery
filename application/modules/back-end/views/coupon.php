            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">คูปอง</h2>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">คูปอง
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($coupon as $key => $coupon) { ?>
                                    <tr>
                                        ...
                                        <td class="product-name"><?php echo $coupon['price'];  ?></td>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">คูปอง</h5>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12 data-field-col">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" value="<?php echo $coupon['name_coupon']; ?>" name="name_coupon" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-12 data-field-col">
                                                                                <div class="form-group">
                                                                                    <label for="data-name">รหัสคูปอง</label>
                                                                                    <input type="text" class="form-control" value="<?php echo $coupon['code_coupon']; ?>" name="code_coupon" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-12 data-field-col">
                                                                                <div class="form-group">
                                                                                    <label for="data-name">ราคาส่วนลด</label>
                                                                                    <input type="text" class="form-control" value="<?php echo $coupon['price']; ?>" name="price" required>
                                                                                </div>
                                                                            </div>
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <div class="add-new-data">
                            <div class="div mt-2 px-2 d-flex new-data-title justify-content-between">
                                <div>
                                    <h4 class="text-uppercase">คูปอง</h4>
                                </div>
                                            ...
                                            <div class="col-sm-12 data-field-col">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        ...
                                                        <input type="text" class="form-control" name="name_coupon" required data-validation-required-message="กรุณากรอก ชื่อคูปอง">
                                                    </div>
                                                    <div class="controls">
                                                        <label for="data-name">รหัสคูปอง</label>
                                                        <input type="text" class="form-control" name="code_coupon" required data-validation-required-message="กรุณากรอก รหัสคูปอง">
                                                    </div>
                                                    <div class="controls">
                                                        <label for="data-name">ราคาส่วนลด</label>
                                                        <input type="text" class="form-control" name="price" required data-validation-required-message="กรุณากรอก ราคาส่วนลด">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
