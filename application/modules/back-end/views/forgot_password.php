...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="public/backend/app-assets/css/core/menu/menu-types/horizontal-menu.css">
    <link rel="stylesheet" type="text/css" href="public/backend/app-assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="public/backend/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center">
                                    <img src="public/backend/app-assets/images/pages/forgot-password.png" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <div class="float-md-left d-block mb-1">
                                                    <a href="Admin_Login" class="btn btn-outline-primary btn-block px-75">Back to Login</a>
                                                </div>
