				...
				<div class="row">
					<div class="col-md-6">
						<div class="offer-left">
							...
							<div class="offer-item">
								<img src="http://placehold.it/90x82" alt="" class="img-responsive">
								<div>
					...
					<div class="col-md-6 hidden-sm hidden-xs">
						<div class="offer-right">
							<img src="http://placehold.it/550x550" alt="" class="img-responsive">
							<a href="menu.html">
								Explore
								<span>The menu</span>
							</a>
		...
		<!-- Section Reservation -->
		<section id="reservation" data-background="http://placehold.it/1902x1100" class="parallax-window">
			<div class="container">
				<div class="row">
					<div class="col-md-7">
					...
					<div class="col-sm-12">
						...
						<div class="delas-carousel">
							<div class="delas-item">
								<img src="http://placehold.it/373x300" alt="" class="img-responsive">
